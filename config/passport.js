...
// const keys = require('./keys'); //Comment out for deployment
...
module.exports = function (passport) {
    ...
    passport.use(new GoogleStrategy({
            clientID: process.env.googleClientID, // comment out for deployment|| keys.googleClientID,
            clientSecret: process.env.googleClientSecret, //comment out for deployment || keys.googleClientSecret,
            callbackURL: "https://req-libs.herokuapp.com/auth/google/callback",
            proxy: true
        },
