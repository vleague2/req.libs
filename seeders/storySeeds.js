...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Stories', [{
        ...
        But Edward Cullen’s *** stiffened, and he turned slowly to *** at me – his 
        face was absurdly *** – with piercing, noun-filled eyes. For an instant, I felt 
        a thrill of genuine ***, raising the hair on my ***. The look only lasted 
        a second, but it chilled me more than the freezing ***.`,
        category: "Twilight",
         createdAt: new Date(),
        updatedAt: new Date()
     }, {
